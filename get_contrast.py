...
input_pams = np.atleast_2d(np.genfromtxt('input.list',delimiter=',', missing_values=9999.0, skip_header=1))
...
_, Vmag, teff, gfeh, vsini = input_pams.T
...
for s,v,t,g,vs,f,c,r in zip(star_name, Vmag, teff, gfeh, vsini, fwhm, contrast, rv_noise):
    fileout.write('{0:12s} {1:8.2f} {2:8.2f} {3:8.2f} {4:8.2f} {5:8.2f} {6:8.2f} {7:8.2f}\n'.format(s,v,t,g,vs,f,c,r))
fileout.close()
